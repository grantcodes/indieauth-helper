...
test('invalid url', (t) => {
  ...
  t.throws(() => validateUrl('https://example'))
  ...
  t.throws(() => validateUrl('http://example.-com'))
  t.throws(() => validateUrl('http://example.com/file?.html'))
  t.throws(() => validateUrl('http://example.com/page?name='))
  t.throws(() => validateUrl('http://example.com/page#section#'))
  t.throws(() => validateUrl('http://example.com^'))
